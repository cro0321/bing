...
const $mouseover = document.querySelector(".header .header-container .header_s2 .s2_menu li")
const hover_sublist = document.querySelector(".header .header-container .header_s2 .s2_menu li .sublist")
console.log(hover_sublist)

const up_down = document.querySelector(".btn_fixed .btn_side")

let num =0

//목표 센터 메뉴 네비의 li를 마우스오버했을때 header_fixed open이 되게 하기.
