...
document.addEventListener("scroll", function(){
    ...
    /*EventListenerOptions 사전에 "수동" 부울을 노출합니다. 패시브 등록 콜백 실행 내부에서 preventDefault를 호출하면 콘솔에 대한 경고만 생성되도록 패시브 EventListener 디스패치와 관련된 동작을 구현합니다. 스크롤 성능을 획기적으로 향상시키는 데 사용할 수 있습니다. huh..?.? ???? 뭔소리야ㅠ */
...
//  신고 새창
// document.querySelector(report_warp).addEventListener("click", function new_report(){
    //     window.location.href = "https://www.bing.co.kr/center/cyber"
    //   }
    // )
    ...
    //     e.addEventListener("mouseover", function(){
    //         console.log(e)
    //         $slick_hover_A.forEach((ele) => {
    //             ele.classList.add("on")
    //         });
    //      })
    // })
    // $hover.addEventListener("mouseover", function(){
    //     $slick_hover_A.classList.toggle("on")
    //  })
